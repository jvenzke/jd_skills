...
6. Check whether the skill forgot steps, struggled, caused confusion, duplicated another skill, or wasted tokens (e.g., verbose outputs, inefficient data generation—propose ways to reduce these).
...
9. Suggest a split when a skill has independent triggers/workflows.
