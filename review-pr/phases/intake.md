...
6. From the active diff, identify:
   ...
   - change intent in at most three sentences of product language: landed behavior (actor, situation, result, must-not) and any differing PR/user expectation. No paths or symbols. The walkthrough turns this into headed opener `###` sections.
